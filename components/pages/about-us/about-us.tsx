...
export default function ImpactMarineGroup() {
	return (
				...
				<div className="grid md:grid-cols-2 gap-8">
					...
					<div className="space-y-6">
						<div className="relative h-64 md:h-80">
							<Image src="/placeholder.svg?height=300&width=500" alt="Impact Marine Group Showroom" layout="fill" objectFit="cover" className="rounded-lg" />
						</div>
					...
					<div className="grid md:grid-cols-2 gap-6">
						...
						<div className="space-y-4">
							<div className="relative h-64">
								<Image src="/placeholder.svg?height=300&width=500" alt="Sea Fox Boat" layout="fill" objectFit="cover" className="rounded-lg" />
							</div>
							<Card>
								<CardContent className="p-4">
		...
		<section id="contact" className="space-y-8">
			<div className="max-w-5xl mx-auto">
				...
				<div className="grid md:grid-cols-2 gap-8">
					...
					<div className="space-y-6">
						<div className="relative h-64 md:h-80">
							<Image src="/placeholder.svg?height=300&width=500" alt="Map to Impact Marine Group" layout="fill" objectFit="cover" className="rounded-lg" />
						</div>
						<Card>
							<CardContent className="p-4">
