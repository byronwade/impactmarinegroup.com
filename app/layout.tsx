      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base">
              ...
              <li><Link href="/inventory" className="hover:text-blue-400 transition-colors">Inventory</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@oceandreamsboats.com" className="hover:text-blue-400 transition-colors break-all">info@oceandreamsboats.com</a>
              </li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col items-center">
          ...
          <Button 
            ...
            variant="default" 
            size="lg" 
            className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-full shadow-lg transition-colors w-full sm:w-auto"
          >
            <a 
