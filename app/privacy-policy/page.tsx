              ...
              <article className="bg-white p-8 rounded-lg shadow-sm">
                ...
                <section id="overview" className="mb-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    At Impact Marine Group, we are committed to providing top-notch service for your vessel. Our service policies are designed to ensure a smooth and efficient experience for all our customers. Please review these policies carefully to understand our procedures and your responsibilities.
                  </p>
                </section>
                ...
                <section id="scheduling" className="mb-8">
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
                    <li>Call to schedule an appointment: <a href="tel:+17708817808" className="text-blue-600 hover:underline">770-881-7808</a> ext 103 & 105</li>
                    <li>Complete the Online Service Request form at <Link href="https://impactmarinegroup.com" className="text-blue-600 hover:underline">impactmarinegroup.com</Link></li>
                    <li>Text us at <a href="sms:+17708817808" className="text-blue-600 hover:underline">770-881-7808</a> with your boat details and service needs</li>
                  </ul>
                ...
                <section id="communication" className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-gray-600"><a href="tel:+17708817808" className="hover:underline">770-881-7808</a></p>
                      <p className="text-gray-600">Service Advisor: EXT 103 TK</p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <h3 className="text-lg font-semibold mb-2">Email</h3>
                      <p className="text-gray-600">Service questions:</p>
                      <p className="text-gray-600"><a href="mailto:TK@impactmarinegroup.com" className="hover:underline">TK@impactmarinegroup.com</a></p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-lg">
