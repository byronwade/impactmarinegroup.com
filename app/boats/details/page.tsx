    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <nav className="text-sm" aria-label="Breadcrumb">
            <ol className="list-none p-0 inline-flex">
              ...
              <li className="flex items-center">
                <Link href="/boats" className="text-gray-300 hover:text-white">Boats</Link>
                <ChevronRight className="w-4 h-4 mx-2" />
              </li>
              <li>
      ...
      <main className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          <div className="lg:col-span-7 space-y-3">
            <div className="relative w-full aspect-square">
              <Image
                src={mainImage.src}
                alt="2022 Boatmate Inboard trailer"
                fill
              ...
              {thumbnails.map((thumb, index) => (
                <div key={index} className="relative w-20 h-20 flex-shrink-0">
                  <Image
                    ...
                    fill
                    className="rounded cursor-pointer hover:opacity-75 object-cover"
                    sizes="80px"
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <ul className="space-y-1">
                <li><strong>Stock #:</strong> 8569T</li>
                <li><strong>Year:</strong> 2022</li>
                <li><strong>Make:</strong> Boatmate</li>
                <li><strong>Model:</strong> Inboard trailer</li>
                <li><strong>Trim:</strong> Black</li>
                <li><strong>Condition:</strong> NEW</li>
                <li><strong>Category:</strong> Trailers</li>
                <li><strong>LOA:</strong> 22&apos;</li>
                <li><strong>Dry Weight W Engines:</strong> 3750 lbs capacity</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <section className="mt-8 sm:mt-12">
          ...
          <p>
            The NEW 2022 Boatmate Inboard trailer Black is a top-of-the-line trailer designed for inboard boats. 
            With its robust construction and sleek black finish, this trailer offers both functionality and style. 
            It&apos;s capable of handling boats up to 22 feet in length and has a dry weight capacity of 3750 lbs, 
            making it suitable for a wide range of inboard boats.
          </p>
        </section>
